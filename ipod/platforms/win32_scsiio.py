# this file is based on kagaimiq/jl-uboot-tool (https://github.com/kagaimiq/jl-uboot-tool/blob/main/scsiio/common.py)
...
class Win32SCSIDev:
	...
	def execute(self, cdb, data_out, data_in, max_sense_len=32, return_sense_buffer=False):
		...
		if not res:
			raise ValueError("Transfer failed: %s" % ctypes.WinError())
